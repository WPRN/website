<template>
  <section id="stats">
    ...
    >
      <v-overlay absolute z-index="0" opacity="0.6" />
            ...
            <div class="text-center">
              <div class="display-3 font-weight-black mb-4">
                <template v-if="tweened">
                  <span class="display-3 font-weight-black mb-4" v-text="value" />
                </template>
                <template v-else>
                  <AnimatedInteger
                    :value="value"
              ...
              <div class="title font-weight-regular text-uppercase" v-text="title" />
            </div>
          </v-col>
        </v-row>
      </v-container>
